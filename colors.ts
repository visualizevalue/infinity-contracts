...
const SVG = `
  <svg width="400" height="1500" viewBox="0 0 400 1600" fill="none" xmlns="http://www.w3.org/2000/svg">
    ${
      colors.map((c, i) => `<rect width="100" height="100" x="${i % 4 * 100}" y="${Math.floor(i / 4) * 100}" fill="hsl(${c.h} ${c.s}% ${c.l}%)" />`)
    }
  </svg>
`
